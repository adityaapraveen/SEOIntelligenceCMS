    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none">
                ...
                <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-fuchsia-800/[0.03] rounded-full blur-[140px]" />
                {/* Grid pattern */}
            ...
            <div className="w-full max-w-[380px] relative z-10 animate-fade-in">
                ...
                <div className="bg-[var(--bg-card)] border border-[var(--border-subtle)] rounded-2xl p-7 backdrop-blur-sm shadow-[var(--shadow-elevated)]">
                    ...
                    <p className="text-[13px] text-[var(--text-muted)] mb-6">Start building with Semantic</p>
